                ...
                >
                  <svg className={classNames(styles.PromptEffectContainer)}>
                    <defs>
                      ...
                      >
                        <stop offset="0%" stopColor="#32CD32" stopOpacity="0%"></stop>
                        <stop offset="40%" stopColor="#32CD32" stopOpacity="80%"></stop>
                        <stop offset="50%" stopColor="#32CD32" stopOpacity="80%"></stop>
                        <stop offset="100%" stopColor="#32CD32" stopOpacity="0%"></stop>
                      </linearGradient>
                  ...
                  >
                    <textarea
                      ...
                      placeholder="How can 1wox help you today?"
                      translate="no"
                    />
                    <ClientOnly>
                      {() => (
